...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={`rounded-lg border border-gray-200 bg-white text-gray-900 p-4 shadow-sm transition-colors duration-200 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-50 ${className}`}
    {...props}
  />
));
